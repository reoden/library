 ...
 *  If any three points are colinear or any four are on the same circle,
 * behavior is undefined. Status: fuzz-tested Time: O(n^2)
 */
#pragma once
...
template <class P, class F> void delaunay(vector<P> &ps, F trifun) {
  ...
  if (sz(ps) > 3)
    trav(t, hull3d(p3)) if ((p3[t.b] - p3[t.a])
                                .cross(p3[t.c] - p3[t.a])
                                .dot(P3(0, 0, 1)) < 0) trifun(t.a, t.c, t.b);
}
