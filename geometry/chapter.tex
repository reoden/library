...
\kactlimport{SegmentDistance.h} %\columnbreak
	\kactlimport {
  SegmentIntersection.h
}
\kactlimport{SegmentIntersectionQ.h} %\columnbreak
	\kactlimport {
  lineIntersection.h
}
...
\kactlimport{MinimumEnclosingCircle.h} %\columnbreak
...
\section { 3D }
\kactlimport{PolyhedronVolume.h} %\columnbreak
